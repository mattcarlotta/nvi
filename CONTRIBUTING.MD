...
5. Add tests within `tests` and then ensure tests pass via `./nob test`
...
This project uses [Clang Format](https://clang.llvm.org/docs/ClangFormat.html) to maintain code style and best practices.
