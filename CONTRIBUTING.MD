...
5. Add tests and test your changes with `zig build test --summary all`
...
This project uses [zls](https://zigtools.org/zls/install/) to maintain code style and best practices.
