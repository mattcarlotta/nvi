...
describe('Log', () => {
    ...
    it('logs a message to the console', () => {
        ...
        expect(mockLog).toHaveBeenCalledWith(expect.stringContaining('Example message.'));
    });

    it('logs a warning message to the console', () => {
        logWarning('Example warning.');

        expect(mockLog).toHaveBeenCalledWith(expect.stringContaining('Example warning.'));
    });

    it('throws an error message to the console', () => {
        logError('Example error.');

        expect(mockLog).toHaveBeenCalledWith(expect.stringContaining('Example error.'));
    });
});
